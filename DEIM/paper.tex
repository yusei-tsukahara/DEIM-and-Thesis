...
\jtitle{論文のタイトル}
\authorlist{%
 \authorentry[hanako@design.inf.shizuoka.ac.jp]{塚原 悠生}{Hanako Shizuoka}{ShizuokaUniv}%
 \authorentry[yamamoto@design.inf.shizuoka.ac.jp]{齊藤 史哲}{Yusuke Yamamoto}{ShizuokaUniv}%
}
